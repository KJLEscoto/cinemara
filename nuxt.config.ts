...
const siteTitle = "Cinemara | KinWebb";
const siteDescription =
  "A curated hub for film lovers to explore movies, browse overviews, and watch trailers — all before deciding what's next. Designed and developed by KinWebb. © 2026 Kent Joemar Escoto.";
const siteVerification = "eMMfU0WDt9Hz-TWRGBTQY-mgFsF66m9octorJRumMzQ";
const siteThumbnail = "https://kinwebb.netlify.app/cinemara_thumbnail.png";
